...
from unreal.train.trainer import Trainer
from unreal.train.rmsprop_applier import RMSPropApplier
...
grad_applier = RMSPropApplier(learning_rate = learning_rate_input,
                              ...
                              device = device)
#
# grad_applier = tf.train.AdamOptimizer(learning_rate=0.0001)
